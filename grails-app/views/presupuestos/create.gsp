        ...
        <div class = box>
            ...
            <section id = "contacto" class = "main" style = "background:white">
                ...
                <div class = "content scaffold-show" role = "main" style = "margin-bottom: 50px">
                    ...
                    <g:form resource = "${this.presupuestos}" method = "POST">
                        
                        <g:hiddenField name = "idEvento" value = "${params.evento}" />
                        ...
                        <fieldset class = "form"style = "margin-left:2.5%">
                            ...
                            <br/> <div class = "field half first">
                                ...
                                <input name = "item" type = "text" placeholder = "Item del presupuesto" required = "required">
                            ...
                            <div class = "field half first">
                                ...
                                <input name = "cantidad" type = "text" placeholder = "Cantidad del Item (Solo Números)" required = "required">
                            ...
                            <div class = "field half first">
                                ...
                                <input name = "valorUnitario" type = "text" placeholder = "Valor del Item (Solo Números)" required = "required">

                            </div> <br/>

                        </fieldset>     
                        
                        <g:submitButton name = "create" class = "save" value = "Crear" style = "margin-left: 40%; width: 20%"/>
