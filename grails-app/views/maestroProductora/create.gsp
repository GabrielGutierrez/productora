        ...
        <div class = box>
            ...
            <section id = "contacto" class = "main" style = "background:white">
                ...
                <div class = "content scaffold-show" role = "main">
                    ...
                    <g:form resource = "${this.maestroProductora}" method = "POST">
                        ...
                        <fieldset class = "form" style = "margin-left:2.5%"> 
                            ...
                            <br/> <div class = "field half first">
                                ...
                                <input name = "razonSocial" type = "text" placeholder = "Nombre de la Productora" required = "required">
                            ...
                            <div class = "field half first">
                                ...
                                <input name = "descripcion" type = "text" placeholder = "Descripción de la Productora" required = "required">
